...
public class FlightsController : ControllerBase
{
    ...
    private List<Flight> Flights = new List<Flight>
    {
        new Flight
        {
            ...
            AerobaticSequenceSignature = "L2B-H1C-R2A-S1D-T2E"
        },
    ...
    [HttpPost("{id}/status")]
    public ActionResult Update(int id, FlightStatus newStatus)
    {
        var flight = Flights.Find(f => f.Id == id);
        if (flight != null)
        {
    ...
    public ActionResult calculateAerodynamics(int id)
    {
        ...
        {
            throw new Exception("Aerodynamics calculation took too long.");
        }
